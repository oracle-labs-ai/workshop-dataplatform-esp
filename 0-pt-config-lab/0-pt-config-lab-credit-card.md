...
Oracle Cloud Free Tier es una cuenta gratuita que ofrece acceso sin costo a varios servicios de Oracle Cloud, con [**USD 300**](https://www.oracle.com/cloud/free/) en créditos promocionales válidos durante **30 días**, además de servicios gratuitos. Incluye, entre otros, cómputo, almacenamiento, bases de datos y servicios de inteligencia artificial.
...
Recibirá un correo electrónico similar al ejemplo siguiente. **Revise la carpeta de correo no deseado**. A continuación, haga clic en **"Verify Email"** para continuar:
...
- **Home Region**:
    - **Seleccione la opción "Brazil East (Sao Paulo)"** como región de origen. Los servicios de IA generativa de Oracle solo están disponibles en algunas regiones:
...
1. Haga clic en **Add payment verification method** para agregar un método de pago.
    > Use preferentemente una **tarjeta física** con un cupo de crédito disponible de, como mínimo, **6 reales**. Es posible que no se acepten tarjetas digitales.

3. Después de agregar el método de pago, marque la casilla **Agreement** para aceptar los términos.
4. Haga clic en **Start my free trial** para iniciar el período de prueba gratuito.
...
Después de iniciar sesión, será redirigido a la consola de Oracle Cloud.
  - Verifique que la **región seleccionada** en la esquina superior derecha sea "Brazil East (São Paulo)" para garantizar acceso a los servicios de IA generativa.
  - En la consola puede consultar sus créditos restantes y acceder a los enlaces de servicios como **OCI Generative AI Services**.
